...
def download():
  css_urls = [
    ...
    "https://cdn.jsdelivr.net/npm/bootstrap-table@" + versions["bs-table"] + "/dist/bootstrap-table.min.css"
  ]
  js_urls = [
    ...
    "https://cdn.jsdelivr.net/npm/bootstrap@" + versions["bootstrap"] + "/dist/js/bootstrap.min.js.map",
    "https://cdn.jsdelivr.net/npm/bootstrap-table@" + versions["bs-table"] + "/dist/bootstrap-table.min.js",
